...
SYSTEM_PROMPT = (
    NSFW_INLINE_PREFIX
    + """Ты — эксперт по образу в социальных сетях. Проанализируй фото человека и определи возможности для усиления визуального присутствия в Instagram, TikTok и других соцсетях.
...
"""
    + PERCEPTION_SCORING_RULES
    + PERCEPTION_CATEGORY_HINTS["social"]
    + """
