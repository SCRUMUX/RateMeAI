...
SYSTEM_PROMPT = (
    NSFW_INLINE_PREFIX
    + """Ты — эксперт по образу в контексте знакомств и свиданий. Проанализируй фото человека и определи возможности для усиления образа.
...
"""
    + PERCEPTION_SCORING_RULES
    + PERCEPTION_CATEGORY_HINTS["dating"]
    + """
