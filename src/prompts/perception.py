...
- ЗАПРЕЩЕНО использовать: "плохо", "слабо", "некрасиво", "не так", "отведен", "не тот", "неуверенный", "закрытый"
...
- current_level определяется так: peak (9.0-10.0), strong (7.5-8.99), solid_base (6.0-7.49), growth_zone (0-5.99)
