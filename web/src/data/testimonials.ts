...
export const TESTIMONIALS: Testimonial[] = [
  ...
  { id: 'ss-doc-medical', category: 'documents', styleKey: 'medical_form', nickname: '@nika_med', shortReview: 'Медкомиссия — приняли без вопросов, нейтральный фон 🩺', fullReview: 'Медкомиссия — приняли без вопросов, нейтральный фон, ровный кадр.', emojiReview: 'Без вопросов 🩺 ровный кадр и нужный фон ✅', beforeScore: 5.5, afterScore: 6.5, deltaRange: [0.02, 0.05], tier: 'Обычный', usage: 'style-showcase' },
  { id: 'ss-doc-driver', category: 'documents', styleKey: 'driver_license', nickname: '@gosha_drive', shortReview: 'Права получил без переделок — фото в плюс 🚗', fullReview: 'Права получил без переделок — фото в плюс, размеры и фон по требованиям.', emojiReview: 'Без переделок 🚗 размеры и фон в норме 📐', beforeScore: 5.5, afterScore: 6.5, deltaRange: [0.02, 0.05], tier: 'Обычный', usage: 'style-showcase' },
