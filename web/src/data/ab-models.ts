 ...
 * со старыми SPA-бандлами. Stand-alone source of truth for the
 * 5-credit cost: ``PREMIUM_CREDIT_COST`` в
 * ``src/services/analysis_request.py`` — держите числа в одном
 * соответствии (фронт показывает, бэк резервирует).
 */
