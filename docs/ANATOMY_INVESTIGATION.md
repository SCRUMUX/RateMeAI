...
**Длина:** ~1450–1500 символов (бюджет 2500, но это уже больше, чем GPT Image 2 Edit обычно «слушает» в одном edit-проходе).
...
Доказательство: §2.2 (баланс cues). Edit-модель (GPT Image 2 Edit) на FAL агрегирует семантику по частотности слов — больше упоминаний «head/bust/portrait/85mm/upper-third» → сильнее склонение в портрет.
