...
LANDING_I18N_MAP: dict[tuple[str, str], dict[str, str]] = {
    ...
    ("home", "pricing"): {
        ...
        "plans[0].title": "pricing.plans.pack5.title",
        "plans[0].price": "pricing.plans.pack5.price",
        "plans[0].photos": "pricing.plans.pack5.photos",
        "plans[0].desc": "pricing.plans.pack5.desc",
        "plans[1].title": "pricing.plans.pack10.title",
        "plans[1].price": "pricing.plans.pack10.price",
        "plans[1].photos": "pricing.plans.pack10.photos",
        "plans[1].desc": "pricing.plans.pack10.desc",
        "plans[2].title": "pricing.plans.pack20.title",
        "plans[2].price": "pricing.plans.pack20.price",
        "plans[2].photos": "pricing.plans.pack20.photos",
        "plans[2].desc": "pricing.plans.pack20.desc",
        "plans[3].title": "pricing.plans.pack50.title",
        "plans[3].price": "pricing.plans.pack50.price",
        "plans[3].photos": "pricing.plans.pack50.photos",
        "plans[3].desc": "pricing.plans.pack50.desc",
    },
    # ---- document_photo -------------------------------------------------
    ("document_photo", "hero"): {
